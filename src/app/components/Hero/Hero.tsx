        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div>
            ...
            <button
              data-aos="zoom-in"
              data-aos-delay="300"
              className="md:px-8 md:py-2.5 px-6 py-1.5 text-white font-semibold text-sm
                  md:text-lg transition-all duration-200 rounded-lg mt-8 bg-blue-700
          ...
          <div
            ...
            {/* md:px-8 md:py-2.5 px-6 py-1.5 text-white font-semibold text-sm md:text-lg */}
          </div>
        </div>
      </div>
    </div>
