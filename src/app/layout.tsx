...
import "./globals.css";
import ResponsiveNav from "./components/Navbar/ResponsiveNav.tsx/ResponsiveNav";
...
export const metadata: Metadata = {
  title: "code-with-ayan Portfolio ",
  description: "code-with-ayan Portfolio With Next.js",
};
